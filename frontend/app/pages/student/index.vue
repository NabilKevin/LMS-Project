      ...
      ><div class="flex items-start justify-between">
        <div>
          ...
          <p
            ...
            :class="toneMap[stat.tone as Tone].textAlt"
          >
            {{ stat.detail }}
          </p>
        </div>
        <div
          ...
          :class="[
            toneMap[stat.tone as Tone].bg,
            toneMap[stat.tone as Tone].text,
          ]"
        >
        ...
        <UCard
          ...
          ><div class="flex items-center gap-4">
            <div
              ...
              :class="[
                toneMap[course.tone as Tone].bg,
                toneMap[course.tone as Tone].text,
              ]"
            >
